...
//    alert(xidelement);
    ...
    var xform = '<div class="formupload">'+
                '<form id="upload'+xidelement+'" method="post" action="'+ getBaseURL()+'ctrfileupload/upload/" enctype="multipart/form-data">'+
   ...
   // alert($('#'+xidelement).val())
     ...
     if(ArrayExt.indexOf(xExt.toLowerCase())!=-1){
        // $('#drop'+xidelement).html(' File : '+"\n"+$('#'+xidelement).val()+"\n"+' Berhasil Di Upload');       
         $('#drop'+xidelement).html('');       
         $('#drop'+xidelement).html('<img src="'+getBaseURL()+"resource/uploaded/img/"+$('#'+xidelement).val()+'" onclick="imgopendialog(\'gbrdialog'+$('#'+xidelement).val()+'\');" class="previewimage'+xidelement+'" style="width:100%;height:100%;"/>'+"\n"+' File : '+"\n"+$('#'+xidelement).val()+"\n"+' Berhasil Di Upload');       
//         $('#drop'+xidelement).html(' File : '+"\n"+$('#'+xidelement).val()+"\n"+' Berhasil Di Upload');       
//     } else{
