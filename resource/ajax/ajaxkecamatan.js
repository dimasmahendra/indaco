...
function dosimpankecamatan() {
    $(document).ready(function () {
        $.ajax({
            ...
            data: "edidx=" + $("#edidx").val() + "&edkode_kecamatan=" + $("#edkode_kecamatan").val() + "&edkecamatan=" + $("#edkecamatan").val() + "&edidkabupaten=" + $("#edidkabupaten").val() + "&edidkota=" + $("#edidkota").val(),
            cache: false,
            dataType: 'json',
            type: 'POST',
