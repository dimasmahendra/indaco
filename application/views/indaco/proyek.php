    	...
    	<div class="row py-5 px-lg-4">
    		<div class="col-12">
    			<div class="proyek-title mb-4">
    				<img class="mr-2 pb-1" src="<?php echo $img_url2 ?>/img/caret.png"><span>PROYEK</span>
    			</div>
    			<?php $i = 0; ?>
				<?php foreach ($proyek as $pro) : ?>
					...
					<?php endif; ?>
						...
						<div class="card" data-toggle="modal" data-target="<?php echo '#proyek_'.$pro->id ?>">
							<img class="card-img" src="<?php echo $img_url.'/'.$pro->image ?>" alt="Card image cap">
							<div class="card-img-overlay d-flex flex-column">
								<div style="visibility:hidden" class="card-header">Month, Date and Year</div>
								<div class="card-body"><h2 class="caption"><?php echo $pro->title ?></h2></div>
...
<?php foreach ($proyek as $pro) : ?>
	<!-- proyek 1 -->
	<div class="modal fade" id="<?php echo 'proyek_'.$pro->id ?>" tabindex="-1" role="dialog">
		<div class="modal-dialog" role="document">
			<div class="modal-content artikel-popup">
				<div class="modal-body">
					...
					<div class="popup-top">
						<img class="img-fluid" src="<?php echo $img_url.'/'.$pro->image ?>">
						<h2 class="modal-title" id="contoh-popupLabel"><?php echo $pro->title ?></h2>
						<div class="row">
