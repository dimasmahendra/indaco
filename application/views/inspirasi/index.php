...
<button name="btAddProduk" id="btAddProduks" type="button" class="btn btn-info" style="margin-bottom: 20px">Add Inspirasi</button>
...
<script type="text/javascript">
	...
	function form_add(){
		$.ajax(
			{
				url : '<?= site_url('ctrinspirasi/form_add')?>',
				type: 'post',
				data : null,
	...
	function form_edit(update_id){
		$.ajax(
			{
				url : '<?= site_url('ctrinspirasi/form_edit')?>',
				type: 'post',
				data : {'id':update_id},
				beforeSend : function( xhr ){
					toastr['info']('harap tunggu');
	...
	function delete_data(delete_id){
		$.ajax(
			{
				url : '<?= site_url('ctrinspirasi/delete')?>',
				type: 'post',
				data : {'id' : delete_id},
				beforeSend : function( xhr ){
					toastr['info']('harap tunggu');
