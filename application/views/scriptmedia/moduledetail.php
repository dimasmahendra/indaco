...
<div class="entry-list">
    <?php if (isset($row->image1)&&($row->image1!='undefined')){ if(!empty($row->image1)){ ?><div class="col-md-4 img-detail-thumb"><a href="#" onclick="onpopup();"><img class="img-fluid" src="<?php echo base_url().'resource/uploaded/img/'.$image1;?>"/></a></div><?php }} ?>
   <?php  
    //print_r($row);
