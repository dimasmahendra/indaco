...
class modelkecamatan extends CI_Model {
    ...
    Function setInsertkecamatan($xidx, $xkode_kecamatan, $xkecamatan, $xidkabupaten, $xidkota) {
        $xStr = " INSERT INTO kecamatan( " .
                ...
                ",idkabupaten" .
                ",idkota" .
                ") VALUES('" . $xidx . "','" . $xkode_kecamatan . "','" . $xkecamatan . "','" . $xidkabupaten . "','" . $xidkota . "')";
        $query = $this->db->query($xStr);
        return $xidx;
    }

    Function setUpdatekecamatan($xidx, $xkode_kecamatan, $xkecamatan, $xidkabupaten, $xidkota) {
    ...
    function getListkecamatanbykabupaten($idkabupaten){
        ...
        if (!empty($idkabupaten)) {
            $xSearch = "Where idkabupaten ='" . $idkabupaten . "' or idkota='".$idkabupaten."'";
        }else $xSearch='';
        $xStr = "SELECT " .
                "idx" .
                ",kode_kecamatan" .
