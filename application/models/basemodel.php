...
class basemodel extends CI_Model {
    ...
    function __construct() {
        ...
        $args = array(
            ...
            'paginationurl' => '',
            'theme' => 'module' //nama file template
        );
    }

    public function header($isi = '') {
...
//        $this->load->model('modelpengguna');
        //echo $this->modelmenu->getMenuAtas(true);
        //exit();
...
//        $xkabupaten = $_POST['edidkabupaten'];
        $xBufResult = '';
        $xBufResult .= form_dropdown('edkabupaten', $this->modelkabupaten->getArrayListkabupatenkota(), '', 'id="edidkabupaten" onchange="kabupatenselect()" class="form-control topinput"') ;
//        $xBufResult .= '<div id="kecamatan"></div>' ;
        $xBufResult .= form_dropdown('edkecamatan', $this->modelkecamatan->getArrayListkecamatan(), '', 'id="edidkecamatan"  class="form-control topinput"') ;
        $xBufResult .= form_dropdown('edidjenisproperti', $this->modeljenisproperti->getArrayListjenisproperti(), '', 'id="edidjenisproperti"  class="form-control topinput"') ;
        $xBufResult .= form_dropdown('edidluas', $this->modelproduk->getArrayListprodukluas(), '', 'id="edidluas"  class="form-control topinput"') ;
        $xBufResult .= form_dropdown('edidtipe', $this->modeltiperumah->getArrayListtiperumah(), '', 'id="edidtipe"  class="form-control topinput"') ;
        $xBufResult .= form_dropdown('edidharga', $this->modelproduk->getArrayListprodukharga(), '', 'id="edidharga"  class="form-control topinput"') ;
        
        $data['kabupaten'] = $xBufResult;
    ...
    public function footer($isi = '') {
        ...
        $data['copyright'] = '<center><label class="fontKaki"><h4>@ Copyright 2017 Member Kudo - All right reserved</h4></label></center>';
