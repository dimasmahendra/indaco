...
function SetBrowse($xIdx) {
    ...
    function setViewAwal($xidmenu) {
        ...
        if (!empty($xUser)) {
            //echo $xUser.$this->session->userdata('idpegawai');
            echo $this->modelgetmenu->setviewadmin($this->setawalview(), '', '', '', '');
    ...
    function createformlogin() {
        ...
        <div class="pull-right">
           <a href="'. base_url("index.php/LanguageSwitcher/code/id") .'"><img src="' . base_url() . 'resource/images/flag/id.png" style="width: auto; height:28px;" /></a>
           <a href="'. base_url("index.php/LanguageSwitcher/code/en") .'"><img src="' . base_url() . 'resource/images/flag/en.png" style="width: auto; height:28px;" /></a>
        </div>
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">'.$this->lang->line('title').'</h3>
                    </div>
                    <div class="panel-body">
                        <form role="form">
                            <fieldset>';
        $xForm .= '<div class="form-group"><input class="form-control" type="text" id="edUser" name ="edUser" placeholder="'.$this->lang->line('username').'"/></div>';
        $xForm .= '<div class="form-group"><input class="form-control" type="password" id="edPassword" name ="edPassword" placeholder="'.$this->lang->line('password').'"/></div>';
        $xForm .=  form_button('button', ''.$this->lang->line('loginbutton').'', 'onclick="dologin();" class="btn btn-md btn-info btn-block"');
        $xForm .= '</div>
                    </div>
                        </div>
                        </div>
    ...
    function setawalview() {
        return '<div class="viewawal" >
                <img src="' . base_url() . 'resource/indaco/img/landing-video.jpg" class="img-responsive" />
             </div>';
    }
