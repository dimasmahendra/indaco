...
//        $xBufResult .= '<div id="kota"></div>';
        ...
        $xBufResult .= setForm('edkode_kelurahan', 'kode_kelurahan', form_input(getArrayObj('edkode_kelurahan', '', '200'))) . '<div class="spacer"></div>';
...
//        $xBufResult .= setForm('edidkecamatan', 'idkecamatan', form_input(getArrayObj('edidkecamatan', '', '200'))) . '<div class="spacer"></div>';
    ...
    function getlistkelurahan($xAwal, $xSearch) {
        ...
        $xbufResult1 = tbaddrow(tbaddcellhead('idx', '', 'width=10%') .
                tbaddcellhead('kode_kelurahan', '', 'width=10%') .
                tbaddcellhead('idkecamatan', '', 'width=10%') .
